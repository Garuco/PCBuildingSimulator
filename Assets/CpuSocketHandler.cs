...
public class CpuSocketHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 direccionCaraDelantera = transform.TransformDirection(-cpu.up);
        ...
        float distance = Vector3.Distance(cpu.position, socket.position);
